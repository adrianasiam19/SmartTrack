      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="bg-white rounded-2xl border border-[#BFDBFE] p-8 lg:p-10 shadow-xl shadow-[#2563EB]/5">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-[#1E293B] mb-1.5">Email</label>
              <input type="email" name="email" id="email" required disabled={isLoading}
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-[#1E293B] mb-1.5">Password</label>
              <div className="relative">
                <input type={showPassword ? 'text' : 'password'} name="password" id="password" required disabled={isLoading}
          ...
          <p className="text-center text-sm text-[#64748B] mt-6">
            ...
            <Link href="/register" className="text-[#2563EB] hover:text-[#1D4ED8] font-semibold">Create one</Link>
          </p>
        </div>        </div>
    </div>
  );
